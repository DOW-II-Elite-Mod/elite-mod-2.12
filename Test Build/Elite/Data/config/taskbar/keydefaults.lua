...
bindings =
{
	...
	ig_weapon_commander_shotgun				="F",	-- Lord General Shotguns
	...
	tau_kroot_squad 			= "O", -- Kroots
	tau_vespid_squad			= "V", -- Vespids
	tau_fire_warriors			= "F", -- Fire Warriors
	tau_pathfinders				= "P", -- Pathfinders
	tau_heavy_weapon_drones			= "H", -- Heavy Weapon Drones
	tau_stealth_suits			= "S", -- Stealth Suits
	tau_devilfish				= "D", -- Devilfish
	tau_hammerhead				= "M", -- Hammerhead
	tau_knarloc				= "K", -- Knarloc
	tau_crisis				= "C", -- Crisis
	tau_broadside				= "B", -- Broadside
	tau_krootox				= "T", -- Krootox
	tau_riptide				= "R", -- Riptide
	
	----------------------------------------------
	------------ Tau Global Abilities ------------
	----------------------------------------------

	tau_debuff_markerlight_global	= "F2", -- Orbital Uplink
	tau_spawn_healing_drones		= "F3", -- Heal drones
	tau_spawn_shield_drone			= "F3", -- Shield drone
	tau_spawn_broadside				= "F4", -- Broadside
	tau_spawn_gundrone				= "F4", -- GunDrone
	tau_bombing_run					= "F5", -- Dakka barrage
	tau_damage_aoe_ion_barrage		= "F6", -- Nuke

	----------------------------------------------
	------------- Tau Unit upgrades --------------
	----------------------------------------------

	tau_pathfinders_shasui = "L",
	tau_pathfinders_rail_rifle = "I",

	tau_fire_warriors_shasui = "L",
	tau_fire_warriors_pulse_rifles = "P",
	tau_fire_warriors_defense_drone = "N",
	tau_fire_warriors_talissera = "I",
	...
	tau_vespid_strain_leader = "L",

	tau_stealth_suits_shasvre = "L",
	tau_stealth_suits_fusion_blaster = "U",

	tau_devilfish_smart_missiles = "N",
	tau_devilfish_flechette = "H",

	tau_broadside_seeker_missile = "M",

	tau_knarloc_angery = "G",

	tau_crisis_team_plasma_rifle = "M",
	tau_crisis_team_fusion_blaster = "B",
	tau_crisis_team_missile_launcher = "L",

	tau_hammerhead_railgun = "L",

	----------------------------------------------
	------------- Tau Hero Upgrades --------------
	----------------------------------------------

	arm_xv8_armoured_battlesuit = "U",
	arm_xv8_recon_battlesuit = "C",
	arm_xv8_command_battlesuit = "T",

	acc_xv8_missile_pod = "M",
	acc_xv8_repulsor_shield = "I",
	acc_xv8_burstcannon = "N",

	wp_xv8_airburst_launcher = "H",
	wp_xv8_plasma_rifle = "R",
	wp_xv8_fusion_blaster = "B",
	wp_xv8_flamer = "L",

	arm_ethereal_conquerer_robe = "B",
	arm_ethereal_combat_armour = "P",
	arm_ethereal_mantle_of_unity = "L",

	acc_ethereal_invocation_stone = "O",
	acc_ethereal_invocation_tides = "D",
	acc_ethereal_invocation_fire = "N",
	acc_ethereal_invocation_grace = "G",

	wp_ethereal_honour_blade = "H",
	wp_ethereal_equalizers = "J",
	wp_ethereal_utilitarian_rod = "U",
	...
	tau_repair 				= "P", -- Repair
	tau_pf_toggle_markerlight		= "E", -- Markerlight
	tau_slow_grenade			= "G", -- Photon grenade
	tau_slow_grenade_improved		= "G", -- Improved photon grenade
	tau_pf_drone_gun			= "K", -- Recon Drone
	tau_pf_drone_debuff			= "P", -- Grav-Inhibitor Drone
	tau_pf_gravity_wave_projector		= "B", -- Gravity Wave Projector
	tau_pf_spawn_drone_buff			= "O", -- Pulse-Accelator Drone
	tau_induction_self_damage_buff		= "E", -- Induction Field

	tau_toggle_tallisera			= "I", -- Talissera
	tau_reletless_fusilade			= "D", -- Reletless Fusilade

	tau_kroot_infiltration			= "I", -- Patient Hunters
	tau_quill_trap				= "P", -- Quill Traps
	tau_kroot_eviscerate			= "C", -- Eviscerate

	tau_vespids_jump			= "J", -- Jump
	tau_ultrasonic_vibrations		= "B", -- Ultrasonic Vibrations
	
	tau_stealthsuits_infiltration		= "I", -- Infiltration
	tau_debuff_mark_target			= "K", -- Mark Target
	tau_stealthsuits_jump			= "J", -- Jump
	
	tau_fletchette_discharge		= "T", -- Fletchette Discharge

	tau_seeker_missile			= "N", -- Seeker Missile

	tau_knarloc_roar			= "W", -- Deafening Roar
	tau_knarloc_charge			= "Y", -- Charge

	tau_crisis_jump				= "J", -- Jump

	tau_clear_out				= "Y", -- Clear Out

	tau_riptide_jump			= "J", -- Jump Jets
	tau_riptide_overcharged_shot		= "B", -- Overcharged Shot
	tau_riptide_overclock_shield		= "M", -- Shields Overcharge

	----------------------------------------------
	------------- Tau hero abilities -------------
	----------------------------------------------

	tau_xv8_jump				= "J", -- Regular jump
	tau_xv8_jump_improved			= "J", -- Improved jump
	tau_xv8_jump_heavy		 	= "J", -- Heavy jump
	tau_xv8_missile_barrage			= "M", -- Missile Barrage
	tau_xv8_ion_battery			= "C", -- Ion Battery
	tau_xv8_fusion_coil_beam		= "W", -- Fusion Coil
	tau_xv8_burstcannon_barrage	 	= "B", -- Burstcannon barrage
	tau_xv8_aoe_damage_buff			= "S", -- Assault Command
	tau_xv8_aoe_damage_debuff		= "S", -- Suppression Command
	tau_xv8_kinetic_pulse			= "T", -- Kinetic Pulse

	tau_ethereal_unifying_mantra		= "R", -- Unifying Mantra
	tau_ethereal_aoe_reveal			= "T", -- Orbital Scan
	tau_ethereal_buff_self_invicibility	= "E", -- Invulnerability
	tau_ethereal_debuff_equalizer		= "J", -- Equalize
	tau_ethereal_buff_ally_stone		= "V", -- Sense of Stone
	tau_ethereal_buff_ally_tides		= "I", -- Power of Tides
	tau_ethereal_buff_ally_fire		= "F", -- Storm of Fire
	tau_ethereal_buff_ally_grace		= "Y", -- Zephyr's Grace
	tau_ethereal_targeted_nuke		= "K", -- Orbital Barrage
	-------------------------------------------
	-------------- Observer panel----------------
	-------------------------------------------
